# {'train_runtime': 2042.3149, 'train_samples_per_second': 21.221, 'train_steps_per_second': 4.245, 'train_loss': 0.9392276856313527, 'epoch': 10.0}
...
class AWSWDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return self.mapped_dataset[self.dataset_type][idx]
